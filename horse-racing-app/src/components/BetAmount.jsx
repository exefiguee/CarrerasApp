    ...
    <div>
      <div className="mb-6">
        <div className="bg-gray-100 rounded-lg p-4 mb-4">
          <p className="text-sm text-gray-600 mb-1">CABALLOS: {selectedHorses.length}</p>
        ...
        <div className="bg-secondary text-white rounded-lg p-4">
          <div className="flex justify-between items-center">
            ...
            <span className="text-2xl font-bold">ARS {amount.toLocaleString()}</span>
          </div>
        ...
        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <p className="text-xs text-yellow-800">
            <strong>Monto mínimo de apuesta:</strong> ARS {minAmount.toLocaleString()}
          </p>
          <p className="text-xs text-yellow-800 mt-1">
            <strong>Monto máximo de apuesta:</strong> ARS {maxAmount.toLocaleString()}
          </p>
          <p className="text-xs text-yellow-800 mt-1">
            (Tope de apuestas: 2)
          </p>
