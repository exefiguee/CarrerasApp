    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-fuchsia-950 to-slate-950">
      ...
      {showProfileModal && user && userData && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-lg flex items-center justify-center z-50 p-4">
          <div className="bg-black-950/95 backdrop-blur-xl rounded-2xl p-6 max-w-md w-full border border-fuchsia-500/30 shadow-2xl shadow-fuchsia-900/30 relative">
            <button
              onClick={() => setShowProfileModal(false)}
              className="absolute top-4 right-4 p-2 rounded-xl bg-fuchsia-900/60 backdrop-blur-sm border border-fuchsia-700/30 text-fuchsia-200 hover:text-white hover:bg-fuchsia-900/80 transition-all">
              <X className="w-5 h-5" />
            </button>

            <div className="flex flex-col items-center text-center mb-6">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-fuchsia-500 to-fuchsia-600 flex items-center justify-center shadow-xl shadow-fuchsia-500/30 mb-4 border-4 border-white/10">
                <User className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-1">Mi Perfil</h3>
              <p className="text-sm text-fuchsia-300">Información de tu cuenta</p>
            </div>

            <div className="space-y-3 mb-6">
              <div className="p-4 rounded-xl bg-fuchsia-900/40 backdrop-blur-sm border border-fuchsia-700/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-xs text-fuchsia-300 mb-1 font-medium">Email</p>
              ...
              <div className="p-4 rounded-xl bg-fuchsia-900/40 backdrop-blur-sm border border-fuchsia-700/30">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-xs text-fuchsia-300 mb-1 font-medium">
                      ID de Usuario
                    </p>
                    <p className="text-xs text-fuchsia-100 font-mono break-all">
                      {userData.ID}
                    </p>
                  </div>
                </div>
              ...
              <div className="p-5 rounded-xl bg-gradient-to-br from-fuchsia-500/20 to-fuchsia-500/20 backdrop-blur-sm border border-fuchsia-400/40 shadow-lg shadow-fuchsia-500/10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-fuchsia-500/30 flex items-center justify-center">
                      <Wallet className="w-6 h-6 text-fuchsia-300" />
                    </div>
                    <div>
                      <p className="text-xs text-fuchsia-200 mb-1 font-medium">
                        Saldo disponible
                      </p>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-fuchsia-600 to-fuchsia-600 hover:from-fuchsia-500 hover:to-fuchsia-500 text-white rounded-xl font-bold text-sm transition-all shadow-xl shadow-fuchsia-500/20 hover:scale-[1.02] flex items-center justify-center gap-2">
                <Plus className="w-5 h-5" />
                Agregar Saldo
              </button>
              <button
                onClick={() => auth.signOut()}
                className="w-full py-3 bg-fuchsia-900/40 hover:bg-fuchsia-900/60 backdrop-blur-sm border border-red-500/40 text-red-400 rounded-xl font-bold text-sm transition-all hover:scale-[1.02] flex items-center justify-center gap-2">
      ...
      {showLoginModal && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-lg flex items-center justify-center z-50 p-4">
          <div className="bg-fuchsia-950/95 backdrop-blur-xl rounded-2xl p-6 max-w-md w-full border border-fuchsia-500/30 shadow-2xl shadow-fuchsia-900/30 relative">
            <button
              onClick={() => {
                setShowLoginModal(false);
                setLoginError("");
            ...
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-sm text-fuchsia-300">Accede a tu cuenta</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="flex items-center gap-2 text-sm font-semibold text-fuchsia-200 mb-2">
                  <svg
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-fuchsia-900/40 backdrop-blur-sm border border-fuchsia-700/30 rounded-xl text-white text-sm placeholder-fuchsia-400 focus:outline-none focus:border-fuchsia-500 focus:bg-fuchsia-900/60 transition-all"
              ...
              {loginError && (
                <div className="p-3 rounded-xl bg-red-500/20 backdrop-blur-sm border border-red-500/40">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-fuchsia-600 to-fuchsia-600 hover:from-fuchsia-500 hover:to-fuchsia-500 text-white rounded-xl font-bold text-sm transition-all shadow-xl shadow-fuchsia-500/20 hover:scale-[1.02]">
                Iniciar Sesión
              </button>
            </form>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="bg-fuchsia-950 px-4 text-sm font-semibold text-fuchsia-400">
                  ¿No tienes cuenta?
                </span>
              </div>
            </div>
            ...
            <button
              onClick={handleCreateAccount}
              className="w-full py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 text-white rounded-xl font-bold text-sm transition-all hover:scale-[1.02] flex items-center justify-center gap-2">
