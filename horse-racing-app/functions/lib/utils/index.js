...
exports.resolveBet = exports.cancelBet = exports.createBet = void 0;
...
exports.createBet = functions.https.onCall(async (request) => {
    ...
    const userName = ((_b = context.auth.token) === null || _b === void 0 ? void 0 : _b.name) || userEmail.split('@')[0] || 'Usuario';
...
exports.cancelBet = functions.https.onCall(async (request) => {
    ...
    try {
        ...
        if (betData.status !== 'pending') {
            throw new functions.https.HttpsError('failed-precondition', `No se puede cancelar una apuesta con estado: ${betData.status}`);
        }
        // ========== 5. USAR TRANSACCIÓN ==========
...
// ========================================
exports.resolveBet = functions.https.onCall(async (request) => {
    const data = request.data;
    const context = request;
